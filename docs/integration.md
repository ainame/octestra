...
| `Ready` | The task is queued for implementation. |
...
not create or validate any additional prompt: whoever starts it is responsible for ensuring that
the task has any repository-required validation instructions.
